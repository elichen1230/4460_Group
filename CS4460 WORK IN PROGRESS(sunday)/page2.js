...
const svg = d3.select("#bar-chart-page2")
  .append("svg")
...
d3.csv("specific_networks.csv").then((data) => {
  ...
  .fill("#2196f3")
  .on("onchange", (val) => {
    const metric = document.getElementById("metricSelector-page2").value;
...
d3.select("#year-slider-page2")
  ...
  document.getElementById("metricSelector-page2").addEventListener("change", () => {
  ...
  d3.select("#reset-button-page2").on("click", () => {
