...
const width = (900 - margin.left - margin.right) * scaleFactor;
const height = (400 - margin.top - margin.bottom) * scaleFactor;
...
svg
  .append("g")
  .attr("transform", `translate(0,${height / 2 + 60 * scaleFactor})`) // Position the axis below the timeline line
  .call(xAxis)
  .selectAll("text")
